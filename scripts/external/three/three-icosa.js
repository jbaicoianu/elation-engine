/* three-icosa addon bundle for three@0.185.1 — generated by utils/build-addons.sh, do not edit by hand */
(() => {
  ...
  // node_modules/three-icosa/dist/three-icosa.module.js
  var three_icosa_module_exports = {};
  __export(three_icosa_module_exports, {
    GLTFGoogleTiltBrushMaterialExtension: () => $ca086492148dd3fa$export$2b011a5b12963d65,
    GLTFGoogleTiltBrushTechniquesExtension: () => $d838b23e95c97ee8$export$24723e25468f5bb7,
    TiltShaderLoader: () => $cf098bb13503440d$export$bcc22bf437a07d8f
  });
  var import_three = __toESM(require_three_global_shim());
  var $cf098bb13503440d$export$bcc22bf437a07d8f = class extends import_three.Loader {
    constructor(manager) {
      super(manager);
    ...
    async load(brushName, onLoad, onProgress, onError) {
      ...
      if (isAlreadyLoaded !== void 0) {
        onLoad(scope.parse(isAlreadyLoaded));
        return;
      }
      const loader = new (0, import_three.FileLoader)(this.manager);
      loader.setPath(this.path);
      loader.setResponseType("text");
      loader.setWithCredentials(this.withCredentials);
      const textureLoader = new (0, import_three.TextureLoader)(this.manager);
      ...
      materialParams.glslVersion = (0, import_three.GLSL3);
      ...
      if (materialParams.uniforms.u_MainTex) {
        ...
        mainTex.wrapS = (0, import_three.RepeatWrapping);
        mainTex.wrapT = (0, import_three.RepeatWrapping);
        mainTex.flipY = false;
      ...
      if (materialParams.uniforms.u_BumpMap) {
        ...
        bumpMap.wrapS = (0, import_three.RepeatWrapping);
        bumpMap.wrapT = (0, import_three.RepeatWrapping);
        bumpMap.flipY = false;
      ...
      if (materialParams.uniforms.u_AlphaMask) {
        ...
        alphaMask.wrapS = (0, import_three.RepeatWrapping);
        alphaMask.wrapT = (0, import_three.RepeatWrapping);
        alphaMask.flipY = false;
        materialParams.uniforms.u_AlphaMask.value = alphaMask;
      }
      for (var lightType in (0, import_three.UniformsLib).lights) materialParams.uniforms[lightType] = (0, import_three.UniformsLib).lights[lightType];
      for (var fogType in (0, import_three.UniformsLib).fog) materialParams.uniforms[fogType] = (0, import_three.UniformsLib).fog[fogType];
      let rawMaterial = new (0, import_three.RawShaderMaterial)(materialParams);
    ...
    lookupMaterialName(nameOrGuid) {
      if (nameOrGuid == null ? void 0 : nameOrGuid.startsWith("ob-")) nameOrGuid = nameOrGuid.substring(3);
      switch (nameOrGuid) {
        case "BlocksBasic:":
        case "BlocksPaper":
  ...
  var $cf098bb13503440d$var$tiltBrushMaterialParams = {
    "BlocksBasic": {
      uniforms: {
        ...
        u_ambient_light_color: {
          value: new (0, import_three.Vector4)(0.3922, 0.3922, 0.3922, 1)
        },
        u_SceneLight_0_color: {
          value: new (0, import_three.Vector4)(0.778, 0.8157, 0.9914, 1)
        },
        u_SceneLight_1_color: {
          value: new (0, import_three.Vector4)(0.4282, 0.4212, 0.3459, 1)
        },
        u_Shininess: {
          value: 0.2
        },
        u_SpecColor: {
          value: new (0, import_three.Vector3)(0.1960784, 0.1960784, 0.1960784)
        },
        u_fogColor: {
          value: new (0, import_three.Vector3)(0.0196, 0.0196, 0.0196)
        },
        u_fogDensity: {
          value: 0
        }
    ...
    "BlocksGem": {
      uniforms: {
        ...
        u_Color: {
          value: new (0, import_three.Vector4)(1, 1, 1, 1)
        },
        u_Shininess: {
          value: 0.9
        },
    ...
    "ChromaticWave": {
      uniforms: {
        ...
        u_time: {
          value: new (0, import_three.Vector4)()
        },
        u_EmissionGain: {
          value: 0.45
        }
    ...
    "Comet": {
      uniforms: {
        ...
        u_AlphaMask_TexelSize: {
          value: new (0, import_three.Vector4)(0.0156, 1, 64, 1)
        },
        u_time: {
          value: new (0, import_three.Vector4)()
        },
    ...
    "DiamondHull": {
      uniforms: {
        ...
        cameraPosition: {
          value: new (0, import_three.Vector3)()
        },
        u_fogColor: {
          value: new (0, import_three.Vector3)(0.0196, 0.0196, 0.0196)
        },
    ...
    "Disco": {
      uniforms: {
        ...
        u_SpecColor: {
          value: new (0, import_three.Vector3)(0.5147059, 0.5147059, 0.5147059)
        },
        u_fogColor: {
          value: new (0, import_three.Vector3)(0.0196, 0.0196, 0.0196)
        },
    ...
    "DoubleTaperedFlat": {
      uniforms: {
        ...
        u_SpecColor: {
          value: new (0, import_three.Vector3)(0, 0, 0)
        },
        u_fogColor: {
          value: new (0, import_three.Vector3)(0.0196, 0.0196, 0.0196)
        },
    ...
    "DuctTape": {
      uniforms: {
        ...
        u_SpecColor: {
          value: new (0, import_three.Vector3)(0.5372549, 0.5372549, 0.5372549)
        },
        u_Shininess: {
          value: 0.414
        },
        ...
        u_BumpMap_TexelSize: {
          value: new (0, import_three.Vector4)(1e-3, 78e-4, 1024, 128)
        }
      },
    ...
    "Embers": {
      uniforms: {
        ...
        u_ScrollDistance: {
          value: new (0, import_three.Vector3)(-0.2, 0.6, 0)
        },
    ...
    "Hypercolor": {
      uniforms: {
        ...
        u_SpecColor: {
          value: new (0, import_three.Vector3)(0.2745098, 0.2745098, 0.2745098)
        },
        u_MainTex: {
    ...
    "Icing": {
      uniforms: {
        ...
        u_SpecColor: {
          value: new (0, import_three.Vector3)(0.2352941, 0.2352941, 0.2352941)
        },
        u_Shininess: {
          value: 0.15
        },
    ...
    "LightWire": {
      uniforms: {
        ...
        u_SpecColor: {
          value: new (0, import_three.Vector3)(0.3455882, 0.3455882, 0.3455882)
        },
        u_time: {
          value: new (0, import_three.Vector4)()
        },
    ...
    "OilPaint": {
      uniforms: {
        ...
        u_BumpMap_TexelSize: {
          value: new (0, import_three.Vector4)(2e-3, 2e-3, 512, 512)
        }
      },
    ...
    "ShinyHull": {
      uniforms: {
        ...
        u_SpecColor: {
          value: new (0, import_three.Vector3)(0.1985294, 0.1985294, 0.1985294)
        },
        u_Shininess: {
          value: 0.743
        },
    ...
    "Snow": {
      uniforms: {
        ...
        u_ScrollDistance: {
          value: new (0, import_three.Vector3)(0, -0.3, 0)
        },
        u_ScrollJitterIntensity: {
          value: 0.01
        },
    ...
    "WetPaint": {
      uniforms: {
        ...
        u_SpecColor: {
          value: new (0, import_three.Vector3)(0.1397059, 0.1397059, 0.1397059)
        },
        u_Shininess: {
          value: 0.85
        },
  ...
  var $ca086492148dd3fa$export$2b011a5b12963d65 = class {
    constructor(parser, brushPath) {
      ...
      this.clock = new (0, import_three.Clock)();
    }
    beforeRoot() {
      ...
      json.materials.forEach((material) => {
        ...
        let nameOrGuid;
        if (extensionsDef == null ? void 0 : extensionsDef[this.name]) nameOrGuid = extensionsDef[this.name].guid;
          ...
          if (newName !== void 0) nameOrGuid = newName;
        }
        ...
        if (((_a = material == null ? void 0 : material.pbrMetallicRoughness) == null ? void 0 : _a.baseColorTexture) && ((_b = materialParams.uniforms) == null ? void 0 : _b.u_MainTex)) {
          const mainTex = json.images[material.pbrMetallicRoughness.baseColorTexture.index];
          mainTex.uri = this.brushPath + ((_c = materialParams.uniforms) == null ? void 0 : _c.u_MainTex.value);
        }
        if ((material == null ? void 0 : material.normalTexture) && ((_d = materialParams.uniforms) == null ? void 0 : _d.u_BumpMap)) {
    ...
    afterRoot(glTF) {
      ...
      for (const scene of glTF.scenes) scene.traverse(async (object) => {
        ...
        if (association === void 0 || association.meshes === void 0) return;
        const mesh = json.meshes[association.meshes];
        mesh.primitives.forEach((prim) => {
          if (prim.material === null || prim.material === void 0) return;
          ...
          if (material.name.startsWith("ob-"))
            ...
            if (exDef !== void 0) brushName = exDef.guid;
          }
          let newName = this.tryReplaceBlocksName(material.name);
          if (newName !== void 0) brushName = newName;
          if (brushName !== void 0) shaderResolves.push(this.replaceMaterial(object, brushName));
    ...
    isTiltGltf(json) {
      ...
      isTiltGltf || (isTiltGltf = json.extensionsUsed && json.extensionsUsed.includes(this.name));
      isTiltGltf || (isTiltGltf = json.extensionsUsed && json.extensionsUsed.includes(this.altName));
      isTiltGltf || (isTiltGltf = "extensions" in json && this.name in json["extensions"]);
      isTiltGltf || (isTiltGltf = "extensions" in json && this.altName in json["extensions"]);
      return isTiltGltf;
    }
    async replaceMaterial(mesh, guidOrName) {
      let renameAttribute = (mesh2, oldName, newName) => {
        if (mesh2.geometry.getAttribute(oldName)) mesh2.geometry.setAttribute(newName, mesh2.geometry.getAttribute(oldName));
        delete mesh2.oldName;
      };
      let copyFixColorAttribute = (mesh2) => {
        function linearToSRGB(x) {
          return x <= 31308e-7 ? x * 12.92 : 1.055 * Math.pow(x, 1 / 2.4) - 0.055;
        }
        let colorAttribute = mesh2.geometry.getAttribute("color");
        if (colorAttribute && colorAttribute.array instanceof Float32Array) {
          ...
          for (let i = 0; i < count; ++i) {
            normalizedColors[i * itemSize + 0] = Math.round(linearToSRGB(src[i * itemSize + 0]) * 255);
            normalizedColors[i * itemSize + 1] = Math.round(linearToSRGB(src[i * itemSize + 1]) * 255);
            normalizedColors[i * itemSize + 2] = Math.round(linearToSRGB(src[i * itemSize + 2]) * 255);
            if (itemSize > 3) normalizedColors[i * itemSize + 3] = Math.round(src[i * itemSize + 3] * 255);
          }
          colorAttribute = new THREE.BufferAttribute(normalizedColors, itemSize, true);
          mesh2.geometry.setAttribute("a_color", colorAttribute);
        } else mesh2.geometry.setAttribute("a_color", mesh2.geometry.getAttribute("color"));
      };
      let shader;
      switch (guidOrName) {
        case "0e87b49c-6546-3a34-3a44-8a556d7d6c3e":
      ...
      mesh.onBeforeRender = (renderer, scene, camera, geometry, material, group) => {
        ...
        if ((_a = material == null ? void 0 : material.uniforms) == null ? void 0 : _a.u_time) {
          const elapsedTime = this.clock.getElapsedTime();
          const time = new (0, import_three.Vector4)(elapsedTime / 20, elapsedTime, elapsedTime * 2, elapsedTime * 3);
          material.uniforms["u_time"].value = time;
        }
        if ((_b = material == null ? void 0 : material.uniforms) == null ? void 0 : _b.cameraPosition) material.uniforms["cameraPosition"].value = camera.position;
        if ((_d = (_c = material == null ? void 0 : material.uniforms) == null ? void 0 : _c.directionalLights) == null ? void 0 : _d.value) {
          if (material.uniforms.directionalLights.value[0]) {
            if (material.uniforms.u_SceneLight_0_color) {
              ...
              material.uniforms.u_SceneLight_0_color.value = new (0, import_three.Vector4)(color.r, color.g, color.b, 1);
            }
          }
          if (material.uniforms.directionalLights.value[1]) {
            if (material.uniforms.u_SceneLight_1_color) {
              ...
              material.uniforms.u_SceneLight_1_color.value = new (0, import_three.Vector4)(color.r, color.g, color.b, 1);
            }
          }
        }
        if ((_f = (_e = material == null ? void 0 : material.uniforms) == null ? void 0 : _e.ambientLightColor) == null ? void 0 : _f.value) {
          if (material.uniforms.u_ambient_light_color) {
            const colorArray = material.uniforms.ambientLightColor.value;
            material.uniforms.u_ambient_light_color.value = new (0, import_three.Vector4)(colorArray[0], colorArray[1], colorArray[2], 1);
          }
        }
        if ((_h = (_g = material == null ? void 0 : material.uniforms) == null ? void 0 : _g.fogColor) == null ? void 0 : _h.value) {
        ...
        if ((_j = (_i = material == null ? void 0 : material.uniforms) == null ? void 0 : _i.fogDensity) == null ? void 0 : _j.value) {
          if (material.uniforms.u_fogDensity) material.uniforms.u_fogDensity.value = material.uniforms.fogDensity.value;
        }
      };
    }
  };
  var $d838b23e95c97ee8$export$24723e25468f5bb7 = class {
    constructor(parser, brushPath) {
    ...
    beforeRoot() {
      ...
      json.materials.map((material, index) => {
        ...
        if (mainTexIndex !== void 0) json.materials[index].pbrMetallicRoughness.baseColorTexture.index = mainTexIndex;
        let bumpMapIndex = extensionsDef.GOOGLE_tilt_brush_techniques.values.BumpMap;
        if (bumpMapIndex !== void 0) json.materials[index].normalTexture.index = bumpMapIndex;
      });
    }
  };

  // utils/addon-entries/three-icosa.js
  var GLTFGoogleTiltBrushMaterialExtension = class extends $ca086492148dd3fa$export$2b011a5b12963d65 {
    beforeRoot() {

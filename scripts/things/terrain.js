elation.require('engine.things.generic', function() {
  elation.component.add("engine.things.terrain0", function() {
    ...
    this.createObject3D = function() {
      ...
      var planemat = elation.engine.materials.getShaderMaterial('terrain_simple', matargs, defines, true);
  ...
  elation.engine.materials.addChunk("poop", {
    ...
    vertex: [
      ...
      "gl_Position.z = texture2D(displacementMap, uv).r * 100.0;",
    ].join("\n"),
    fragment: [
      //"gl_FragColor = vec4(0,1,0,1);"
